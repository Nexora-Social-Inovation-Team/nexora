...
import markImage from "../assets/favicon.png";
...
/**
 * Brand ramp, sampled off brand/nexora-logo.jpg. Decorative only: on `bg` the
 * cyan measures 1.2:1, magenta 2.9:1 and the logo blue 4.2:1, so none of these
 * may carry text. Rings, badges and rules only — `link` stays the blue that
 * passes AA.
 */
export const brand = {
  cyan: "#0DFCFF",
  ...
  return (
    <View style={s.switchWrap}>
      <Pressable
        ...
        style={s.brand}
      >
        <Image source={markImage} style={s.mark} accessibilityIgnoresInvertColors />
...
export const s = StyleSheet.create({
  ...
  // The real mark, generated by scripts/build-brand-assets.py.
